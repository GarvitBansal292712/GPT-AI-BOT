...
const Home = () => {
  return (
    <>
      {/* Header */}
      <div className="backimg w-full  p-4 bg-cover bg-center font-mono text-white ">
        {/* NAVBAR */}
        ...
        <div className="flex justify-center items-center my-10">
          <div className="flex flex-col justify-center items-center">
            ...
            <h1 className="text-[4rem] text-center font-bold leading-[70px] my-6">
      ...
      <div className="flex flex-col justify-center items-center font-mono">
        ...
        <h1 className="text-[2rem] text-white text-center font-bold my-6">
          Your Device just got
          <br /> smarter
        </h1>
        <p className="text-center text-[#c7c3c3]">
          Write smarter, faster and answer question quicker with Chatgpt in
      ...
      {/* Features */}
      {/* footer */}
      <div className="flex justify-around items-center text-white font-mono p-3 border-t-[2px] border-[#FFFFFF14]">
        <div className="md:flex items-center md:justify-center md:gap-3">

        <h1 className="text-center">
        • Created By: Garvit Bansal  
        </h1>
...
<a href=""  className=""><FaGithub  size={20} /></a>
        </div>
      </div>
      {/* footer */}
    </>
